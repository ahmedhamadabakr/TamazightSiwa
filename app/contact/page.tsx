      ...
      <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <section className="relative min-h-[60vh] sm:min-h-[50vh] md:h-[60vh] flex items-center justify-center">
          ...
          >
            ...
            <p className="text-sm sm:text-lg md:text-2xl max-w-2xl mx-auto opacity-90">
              Ready to start your Siwa adventure? We’re here to help.
            </p>
          </MotionDiv>
        </section>
              ...
              {[
                {
                  ...
                  a: "October to April is ideal.",
                },
                {
                  q: "How can I reach Siwa?",
                  a: "From Cairo or Alexandria by road.",
                },
                {
                  q: "Is Siwa family friendly?",
                  a: "Yes, tours are suitable for all ages.",
                },
              ].map((faq, i) => (
                <AccordionItem
                  key={i}
                  value={`faq-${i}`}
                  className="bg-background rounded-lg border px-3"
                >
              ...
              {[
                ...
                <Card key={s.name} className="hover:shadow-lg transition">
                  <CardContent className="p-6 flex flex-col items-center">
                    <div
                      className={`w-14 h-14 rounded-full ${s.bg} flex items-center justify-center mb-4`}
                    >
                      {s.icon}
                    </div>
