// Optimized countries data with lazy loading
export interface Country {
  value: string;
  label: string;
}

// Split countries by continent for better code splitting
...
// Lazy load function for countries
export async function getCountriesByContinent() {
  return [
    { label: "Africa", options: africanCountries },
    { label: "Asia", options: asianCountries },
    { label: "Europe", options: europeanCountries },
    { label: "North America", options: northAmericanCountries },
    { label: "South America", options: southAmericanCountries },
